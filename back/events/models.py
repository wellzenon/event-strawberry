...
class Event(models.Model):
    ...
    user_presences = models.ManyToManyField(AUTH_USER_MODEL, through="Presence", related_name="event_presences")
    user_comments = models.ManyToManyField(AUTH_USER_MODEL, through="Comment", related_name="event_comments")
